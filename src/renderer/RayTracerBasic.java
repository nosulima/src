...
public class RayTracerBasic extends RayTracerBase{
	...
	//calculation the reflection ray
	  public Ray constructReflectedRay(Point point, Vector v,Vector n) {
	...
	public Ray constructRefractedRay(Point point, Vector l,Vector n) {
	...
	private Color calcLocalEffects(GeoPoint intersection, Ray ray, double k) {
		Vector v = ray.getDirectionVector (); //from camera to point
	...
	private Color calcGlobalEffects(GeoPoint geopoint, Ray ray, int level, double k) {
		...
		if (kkr > MIN_CALC_COLOR_K) {//we can calculate the reflection
			Ray reflectedRay = constructReflectedRay(geopoint.point, ray.getDirectionVector(),n);
		...
		if (kkt > MIN_CALC_COLOR_K) {//we can calculate the transparency
			Ray refractedRay = constructRefractedRay(geopoint.point, ray.getDirectionVector(),n);
